            ...
            {fileUrl ? (
                <div className={Style.voterInfo}>
                    ...
                    <div className={Style.voterInfo_paragraph}>
                        ...
                        <p>
                            Pos: &nbsp;<span>{candidateForm.age}</span>
                        </p>
                    </div>
                </div>
            ) : (
        ...
        <div className={Style.voter}>
            <div className={Style.voter_container}>
                ...
                <div className={Style.input_container}>
                    <Input  inputType="text" title="Adress" placeholder="Voter Address" handleClick={(e) => setCandidateForm({...candidateForm, address: e.target.value})}/>
                    <Input  inputType="text" title="Name" placeholder="Voter Name" handleClick={(e) => setCandidateForm({...candidateForm, name: e.target.value})}/>
                    <Input  inputType="text" title="age" placeholder="Voter age" handleClick={(e) => setCandidateForm({...candidateForm, position: e.target.value})}/>

                <div className={Style.Button_container}>
                    <Button btnName="Authorised Candidate" handleClick={()=> setCandidate(candidateForm, fileUrl, router)}/>
                </div>
                </div>
            </div>
        </div>
